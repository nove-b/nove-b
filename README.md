...
- 2026-05-17 📝 Issue: [@nove-b.dev created issue 'Failed to submit pull request: "xrpc request failed" error' in @tangled.org/core](https://tangled.org/@tangled.org/core/issues/573)
- 2026-05-12 📝 Issue: [@nove-b.dev created issue 'Add user mention suggestions when typing "@" in comments' in @tangled.org/core](https://tangled.org/@tangled.org/core/issues/556)
- 2026-05-02 📦 Repository: [@nove-b.dev created repository 'tangled-activity'](https://tangled.org/@nove-b.dev/tangled-activity)
